...
with open(os.path.join('maps', 'map3.pkl'), 'rb+') as f:
...
plt.plot(dict_rewards['ep'], dict_rewards['avg'], label='avg')
plt.plot(dict_rewards['ep'], dict_rewards['min'], label='min')
plt.plot(dict_rewards['ep'], dict_rewards['max'], label='max')
plt.legend(loc=4)
plt.show()
